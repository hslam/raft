...
func newSnapshotReadWriter(node *Node,name string)*SnapshotReadWriter  {
	s:=&SnapshotReadWriter{
		...
		lastIncludedIndex:newPersistentUint64(node,DefaultLastIncludedIndex),
		lastIncludedTerm:newPersistentUint64(node,DefaultLastIncludedTerm),
		lastTarIndex:newPersistentUint64(node,DefaultLastTarIndex),
